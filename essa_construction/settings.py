"""
Django settings for essa_construction project.
"""
...
ALLOWED_HOSTS = [
    'Essa-construction-4.onrender.com',
    'localhost',
    '127.0.0.1',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'essa_construction', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'essa_construction.users.context_processors.allauth_settings',
            ],
        },
    },
]
...
ACCOUNT_ADAPTER = 'essa_construction.users.adapters.AccountAdapter'
